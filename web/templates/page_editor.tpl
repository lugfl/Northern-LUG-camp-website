...
<div id="page_delete" style="position:absolute; z-index: 99; left: -10000px; top: -10000px; background: white; border: 1px solid #685e9c; padding: 10px;">
	<form id="pagedel_form" method="POST">
		...
		<span class="editor_buttons"><button onclick="submit_form('pagedel_form');">Seite löschen</button><button onclick="show_window('page_delete', false); return false;">abbrechen</button></span>
	</form>
</div>
